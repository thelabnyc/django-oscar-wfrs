    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "middle_initial",
                    models.CharField(max_length=1, verbose_name="Middle Initial"),
                ),
                (
                    "last_name",
                ...
                (
                    "phone_number",
                    oscar.models.fields.PhoneNumberField(verbose_name="Phone Number"),
                ),
                (
                    "address",
                    models.CharField(
                        max_length=100, verbose_name="Last 4 digits of account number"
                    ),
                ),
                (
                    "credit_limit",
                    models.DecimalField(
                        decimal_places=2,
                        max_digits=12,
                        verbose_name="Account Credit Limit",
                    ),
                ),
                (
                    "balance",
                    models.DecimalField(
                        decimal_places=2,
                        max_digits=12,
                        verbose_name="Current Account Balance",
                    ),
                ),
                (
                    "open_to_buy",
                    models.DecimalField(
                        decimal_places=2,
                        max_digits=12,
                        verbose_name="Current Available Credit",
                    ),
                ),
                (
                    "last_payment_date",
                    models.DateField(null=True, verbose_name="Last Payment Date"),
                ),
                (
                    "last_payment_amount",
                    models.DecimalField(
                ...
                (
                    "payment_due_date",
                    models.DateField(null=True, verbose_name="Payment Due Date"),
                ),
                (
                    "payment_due_amount",
                    models.DecimalField(
                        ...
                        max_digits=12,
                        null=True,
                        verbose_name="Payment Due on Account",
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="_cacreditapp_inquiries_+",
                to="wellsfargo.AccountInquiryResult",
                verbose_name="Account Inquiries",
            ),
        ),
        migrations.AddField(
            model_name="cajointcreditapp",
            name="inquiries",
            field=models.ManyToManyField(
                related_name="_cajointcreditapp_inquiries_+",
                to="wellsfargo.AccountInquiryResult",
                verbose_name="Account Inquiries",
            ),
        ),
        migrations.AddField(
            ...
            name="inquiries",
            field=models.ManyToManyField(
                related_name="_uscreditapp_inquiries_+",
                to="wellsfargo.AccountInquiryResult",
                verbose_name="Account Inquiries",
            ),
        ),
        migrations.AddField(
            ...
            name="inquiries",
            field=models.ManyToManyField(
                related_name="_usjointcreditapp_inquiries_+",
                to="wellsfargo.AccountInquiryResult",
                verbose_name="Account Inquiries",
            ),
        ),
