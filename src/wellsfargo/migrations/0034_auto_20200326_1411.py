    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "address_line_1",
                    models.CharField(
                        help_text="The street address line 1. This cannot contain a PO Box.",
                        max_length=26,
                ...
                (
                    ...
                    oscar.models.fields.NullCharField(
                        help_text="The street address line 2.",
                        max_length=26,
                ...
                (
                    "city",
                    models.CharField(
                        help_text="The city component of the address.",
                        max_length=18,
                        verbose_name="City",
                    ),
                ),
                (
                    ...
                    localflavor.us.models.USStateField(
                        help_text="The two-letter US state code component of the address.",
                        max_length=2,
                        verbose_name="State",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "first_name",
                    models.CharField(
                        help_text="The applicant’s first name.",
                        max_length=15,
                ...
                (
                    "last_name",
                    models.CharField(
                        help_text="The applicant’s last name.",
                        max_length=20,
                ...
                (
                    "middle_initial",
                    oscar.models.fields.NullCharField(
                        help_text="The applicant’s middle initial.",
                        max_length=1,
                ...
                (
                    ...
                    wellsfargo.core.fields.DateOfBirthField(
                        help_text="The applicant’s date of birth.",
                        null=True,
                ...
                (
                    ...
                    wellsfargo.core.fields.USSocialSecurityNumberField(
                        help_text="The applicant’s Social Security Number.",
                        max_length=11,
                ...
                (
                    "annual_income",
                    models.IntegerField(
                        help_text="The applicant’s annual income.",
                        validators=[
                ...
                (
                    ...
                    models.EmailField(
                        blank=True,
                        help_text="The applicant’s email address.",
                        max_length=50,
                        null=True,
                ...
                (
                    ...
                    phonenumber_field.modelfields.PhoneNumberField(
                        help_text="The applicant’s home phone number.",
                        max_length=128,
                ...
                (
                    ...
                    phonenumber_field.modelfields.PhoneNumberField(
                        blank=True,
                        help_text="The applicant’s mobile phone number.",
                        max_length=128,
                        null=True,
                ...
                (
                    ...
                    phonenumber_field.modelfields.PhoneNumberField(
                        blank=True,
                        help_text="The applicant’s work phone number.",
                        max_length=128,
                        null=True,
                ...
                (
                    "employer_name",
                    oscar.models.fields.NullCharField(
                        help_text="The name of the applicant’s employer.",
                        max_length=30,
                ...
                (
                    ...
                    oscar.models.fields.NullCharField(
                        ...
                        help_text="The applicant’s housing status.",
                        max_length=5,
                ...
                (
                    "address",
                    models.ForeignKey(
                        help_text="The applicant’s address.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reservation_number",
                    oscar.models.fields.NullCharField(
                        help_text="The unique code that correlates with the user’s reservation.",
                        max_length=20,
                ...
                (
                    "application_id",
                    oscar.models.fields.NullCharField(
                        help_text="An 8-character alphanumeric ID identifying the application.",
                        max_length=8,
                        verbose_name="Prequalified Application ID",
                    ),
                ),
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        help_text="This denotes the total price value of the items that the applicant’s shopping cart.",
                        null=True,
                        validators=[
                            django.core.validators.MinValueValidator(0),
                            django.core.validators.MaxValueValidator(99999),
                        ],
                        verbose_name="Requested Credit Limit",
                    ),
                ),
                (
                    "language_preference",
                    models.CharField(
                        ...
                        default="E",
                        help_text="The main applicant’s language preference values",
                        max_length=1,
                ...
                (
                    "salesperson",
                    oscar.models.fields.NullCharField(
                        help_text="Alphanumeric value associated with the salesperson.",
                        max_length=10,
                        verbose_name="Sales Person ID",
                    ),
                ),
                (
                    "main_applicant",
                    models.ForeignKey(
                        help_text="The main applicant’s personal details.",
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="+",
                        to="wellsfargo.CreditApplicationApplicant",
                        verbose_name="Main Applicant",
                    ),
                ),
                (
                    "joint_applicant",
                    models.ForeignKey(
                        blank=True,
                        help_text="The joint applicant’s details.",
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="+",
                        to="wellsfargo.CreditApplicationApplicant",
                        verbose_name="Joint Applicant",
                    ),
                ),
                (
                    "status",
                ...
                (
                    ...
                    models.CharField(
                        default="Website",
                        help_text="Where/how is user applying? E.g. Website, Call Center, In-Store, etc.",
                        max_length=25,
                ...
                (
                    ...
                    models.GenericIPAddressField(
                        blank=True,
                        help_text="Submitting User's IP Address",
                        null=True,
                        verbose_name="Submitting User's IP Address",
                    ),
                ),
                (
                    "created_datetime",
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Which merchant account submitted this application?",
                        null=True,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name="+",
                to="wellsfargo.CreditApplicationAddress",
                verbose_name="Joint Applicant Address",
            ),
        ),
        migrations.AddField(
            model_name="accountinquiryresult",
            ...
            field=oscar.models.fields.NullCharField(
                max_length=50, verbose_name="Joint Applicant Name"
            ),
        ),
        migrations.AddField(
            model_name="accountinquiryresult",
            ...
            field=models.ForeignKey(
                ...
                related_name="+",
                to="wellsfargo.CreditApplicationAddress",
                verbose_name="Main Applicant Address",
            ),
        ),
        migrations.AddField(
            model_name="accountinquiryresult",
            ...
            field=oscar.models.fields.NullCharField(
                max_length=50, verbose_name="Main Applicant Name"
            ),
        ),
    ]
