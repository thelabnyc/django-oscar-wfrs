    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_ssn', models.CharField(max_length=50, blank=True, null=True, verbose_name='Social Insurance Number')),
                ('main_address_state', models.CharField(max_length=2, verbose_name='Province')),
                ('main_address_postcode', models.CharField(max_length=10, verbose_name='Postcode')),
                ...
                ('main_drivers_license_province', models.CharField(max_length=2, blank=True, null=True, verbose_name='Driver’s License Province')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_drivers_license_province', models.CharField(max_length=2, blank=True, null=True, verbose_name='Driver’s License Province')),
                ('main_photo_id_expiration', models.DateField(verbose_name='Photo ID Expiration Date')),
                ('joint_ssn', models.CharField(max_length=50, blank=True, null=True, verbose_name='Social Insurance Number')),
                ('joint_address_state', models.CharField(max_length=2, verbose_name='Province')),
                ('joint_address_postcode', models.CharField(max_length=10, verbose_name='Postcode')),
                ...
                ('joint_drivers_license_province', models.CharField(max_length=2, blank=True, null=True, verbose_name='Driver’s License Province')),
