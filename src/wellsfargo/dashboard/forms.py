...
class ApplicationSearchForm(forms.Form):
    ...
    status = forms.ChoiceField(
        required=False,
        label=_("Status"),
        choices=((("", _("All Statuses")),) + CREDIT_APP_STATUSES),
    )
    ...
    created_date_from = forms.DateTimeField(
        required=False, label=_("Submitted After"), widget=DateTimePickerInput
    )
    created_date_to = forms.DateTimeField(
        required=False, label=_("Submitted Before"), widget=DateTimePickerInput
    )
...
class PreQualSearchForm(forms.Form):
    ...
    # Advanced Search
    customer_initiated = forms.NullBooleanField(
        required=False, label=_("Customer Initiated?")
    )
    ...
    status = forms.ChoiceField(
        required=False,
        label=_("Status"),
        choices=((("", _("All Statuses")),) + PREQUAL_TRANS_STATUS_CHOICES),
    )
    created_date_from = forms.DateTimeField(
        required=False, label=_("Submitted After"), widget=DateTimePickerInput
    )
