    ...
    def render_to_response(self, context, **response_kwargs):
        if self.is_csv_download():
            return self.download_applications(
                self.request, context[self.context_table_name]
            )
...
class CreditApplicationListView(CSVDownloadableTableMixin, SingleTableView):
    ...
    def apply_search(self, qs):
        ...
        if search_text:
            ...
            self.filter_descrs.append(
                _("Application contains “%(text)s”") % dict(text=search_text)
            )
        ...
        if name:
            ...
            self.filter_descrs.append(
                _("Applicant name contains “%(name)s”") % dict(name=name)
            )
        ...
        if email:
            ...
            self.filter_descrs.append(
                _("Applicant email contains “%(email)s”") % dict(email=email)
            )
        ...
        if address:
            ...
            self.filter_descrs.append(
                _("Applicant address contains “%(address)s”") % dict(address=address)
            )
        ...
        if phone:
            ...
            self.filter_descrs.append(
                _("Phone number contains “%(phone)s”") % dict(phone=phone)
            )
        ...
        if created_date_from:
            ...
            self.filter_descrs.append(
                _("Application submitted after %(date)s")
                % dict(date=created_date_from.strftime("%c"))
            )
        ...
        if created_date_to:
            ...
            self.filter_descrs.append(
                _("Application submitted before %(date)s")
                % dict(date=created_date_to.strftime("%c"))
            )
        ...
        if user_id:
            ...
            self.filter_descrs.append(
                _("Application owned by “%(name)s”") % dict(name=user.get_full_name())
            )
        ...
        if submitting_user_id:
            ...
            self.filter_descrs.append(
                _("Application submitted by “%(name)s”")
            ...
            self.filter_descrs.append(
                _("Application submitted by “%(name)s”") % dict(name=submitted_by)
            )
...
class PreQualificationListView(CSVDownloadableTableMixin, SingleTableView):
    ...
    def apply_search(self, qs):
        ...
        if search_text:
            ...
            self.filter_descrs.append(
                _("Request contains “%(text)s”") % dict(text=search_text)
            )
        ...
        if customer_initiated is not None:
            ...
            self.filter_descrs.append(
                _("Customer Initiated is “%(text)s”") % dict(text=customer_initiated)
            )
        ...
        if first_name:
            ...
            self.filter_descrs.append(
                _("First name is “%(text)s”") % dict(text=first_name)
            )
        ...
        if last_name:
            ...
            self.filter_descrs.append(
                _("Last name is “%(text)s”") % dict(text=last_name)
            )
        ...
        if status:
            ...
            self.filter_descrs.append(
                _("Status is “%(text)s”")
                % dict(text=get_prequal_trans_status_name(status))
            )
        ...
        if created_date_from:
            ...
            self.filter_descrs.append(
                _("Created after %(text)s") % dict(text=created_date_from)
            )
        ...
        if created_date_to:
            ...
            self.filter_descrs.append(
                _("Created before %(text)s") % dict(text=created_date_to)
            )
