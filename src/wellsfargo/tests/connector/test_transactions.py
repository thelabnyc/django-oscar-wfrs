...
class TransactionsAPIClientTest(BaseTest):
    ...
    def test_submit_transaction_success(self, rmock):
        ...
        self.mock_successful_transaction_request(rmock, additional_matcher=match_submit_transaction)
    ...
    def test_submit_transaction_denied(self, rmock):
        ...
        self.mock_declined_transaction_request(rmock, additional_matcher=match_submit_transaction)
        ...
        with self.assertRaises(TransactionDenied):
            TransactionsAPIClient().submit_transaction(request,
                transaction_uuid='c17381a3-22fa-4463-8b0a-a3c18f6c4a44')
