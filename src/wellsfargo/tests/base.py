...
class BaseTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.joe = User.objects.create_user(
            username="joe", password="schmoe", email="joe@example.com"
        )
        ...
        self.credentials = APIMerchantNum.objects.create(
            merchant_num="1111111111111111", user_group=None, priority=1
        )
        self.sdk_credentials = SDKMerchantNum.objects.create(
            merchant_num="1111111111112222", user_group=None, priority=1
        )
        return super().setUp()
    ...
    def mock_successful_individual_account_inquiry(self, rmock, **kwargs):
        rmock.post(
            "https://api-sandbox.wellsfargo.com/credit-cards/private-label/new-accounts/v2/details",
            json={
                "merchant_number": "1111111111111111",
                "transaction_code": "C1",
                "unique_id": "00001DGh",
