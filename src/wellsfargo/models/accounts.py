...
class AccountInquiryResult(AccountNumberMixin, models.Model):
    ...
    main_applicant_address = models.ForeignKey('wellsfargo.CreditApplicationAddress',
        verbose_name=_("Main Applicant Address"),
        related_name='+',
        null=True, blank=True,
        on_delete=models.SET_NULL)
    joint_applicant_address = models.ForeignKey('wellsfargo.CreditApplicationAddress',
