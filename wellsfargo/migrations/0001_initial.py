...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('account', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='wfrs_metadata', serialize=False, to='oscar_accounts.Account', verbose_name='Account')),
                ('locale', models.CharField(choices=[('en_US', 'English (US)'), ('en_CA', 'English (CA)'), ('fr_CA', 'French (CA)')], max_length=5, verbose_name='Locale')),
                ('account_number', models.CharField(max_length=16, validators=[django.core.validators.MinLengthValidator(16), django.core.validators.MinLengthValidator(16)], verbose_name='Wells Fargo Account Number')),
            ],
        ),
        migrations.CreateModel(
            name='CACreditApp',
            fields=[
                ...
                ('main_ssn', wellsfargo.fields.CASocialInsuranceNumberField(blank=True, null=True, verbose_name='Social Insurance Number')),
                ('main_address_state', wellsfargo.fields.CAProvinceField(verbose_name='Province')),
                ('main_address_postcode', wellsfargo.fields.CAPostalCodeField(verbose_name='Postcode')),
                ('main_home_phone', wellsfargo.fields.CAPhoneNumberField(verbose_name='Home Phone')),
                ...
                ('main_employer_phone', wellsfargo.fields.CAPhoneNumberField(verbose_name='Employer Phone Number')),
                ('main_cell_phone', wellsfargo.fields.CAPhoneNumberField(blank=True, null=True, verbose_name='Cell Phone')),
                ...
                ('main_drivers_license_province', wellsfargo.fields.CAProvinceField(blank=True, null=True, verbose_name='Driver’s License Province')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_drivers_license_province', wellsfargo.fields.CAProvinceField(blank=True, null=True, verbose_name='Driver’s License Province')),
                ('main_photo_id_expiration', models.DateField(verbose_name='Photo ID Expiration Date')),
                ('joint_ssn', wellsfargo.fields.CASocialInsuranceNumberField(blank=True, null=True, verbose_name='Social Insurance Number')),
                ('joint_address_state', wellsfargo.fields.CAProvinceField(verbose_name='Province')),
                ('joint_address_postcode', wellsfargo.fields.CAPostalCodeField(verbose_name='Postcode')),
                ...
                ('joint_employer_phone', wellsfargo.fields.CAPhoneNumberField(verbose_name='Employer Phone Number')),
                ('joint_cell_phone', wellsfargo.fields.CAPhoneNumberField(blank=True, null=True, verbose_name='Cell Phone')),
                ...
                ('joint_drivers_license_province', wellsfargo.fields.CAProvinceField(blank=True, null=True, verbose_name='Driver’s License Province')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_code', models.CharField(choices=[('5', 'Authorization for Future Charge'), ('7', 'Cancel Existing Authorization'), ('4', 'Return or Credit'), ('9', 'Time-out Reversal for Return or Credit'), ('VS', 'Void Sale'), ('VR', 'Void Return')], default='5', max_length=2, verbose_name='Transaction Type')),
                ...
                ('auth_number', models.CharField(default='000000', max_length=6, validators=[django.core.validators.MinLengthValidator(6), django.core.validators.MinLengthValidator(6), django.core.validators.RegexValidator('^[0-9]{6}$')], verbose_name='Authorization Number')),
                ('dest_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dest_requests', to='oscar_accounts.Account', verbose_name='Destination Account')),
                ('source_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='source_requests', to='oscar_accounts.Account', verbose_name='Source Account')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transaction_requests', to=settings.AUTH_USER_MODEL, verbose_name='Requesting User')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket_number', models.CharField(blank=True, max_length=12, null=True, verbose_name='Ticket Number')),
                ('plan_number', models.CharField(max_length=4, validators=[django.core.validators.MinLengthValidator(4), django.core.validators.MinValueValidator(1001), django.core.validators.MaxValueValidator(9999)], verbose_name='Plan Number')),
                ...
                ('transfer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='wfrs_metadata', to='oscar_accounts.Transfer', verbose_name='Transfer')),
            ],
        ),
        migrations.CreateModel(
            name='USCreditApp',
            fields=[
                ...
                ('new_sales_person', models.CharField(blank=True, max_length=10, null=True, verbose_name='New Sales Person Name')),
                ('email', models.EmailField(max_length=80, verbose_name='Email')),
                ('main_ssn', wellsfargo.fields.USSocialSecurityNumberField(verbose_name='Social Security Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_cell_phone', localflavor.us.models.PhoneNumberField(blank=True, null=True, verbose_name='Cell Phone')),
                ('main_occupation', models.CharField(blank=True, max_length=24, null=True, verbose_name='Occupation')),
                ('joint_ssn', wellsfargo.fields.USSocialSecurityNumberField(verbose_name='Social Security Number')),
